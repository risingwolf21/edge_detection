...
class EdgeDetector {
  ...
  Future<img.Image> applyFilterOnUint32List(Uint32List image, int width,
    ...
    assert(sx.length == sy.length);
    assert(sx[0].length == sy[0].length);
